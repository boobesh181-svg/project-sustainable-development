...
async def seed_dashboard() -> None:
    ...
    async with AsyncSessionLocal() as session:
        ...
        # If projects already exist, do not duplicate seed data.
        existing_projects = (
        ...
        for i, t in enumerate([x for x in tokens if x.redeemed][:10]):
